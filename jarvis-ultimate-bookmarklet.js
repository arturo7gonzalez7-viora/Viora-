// JARVIS ULTIMATE TRADING COPILOT - COMPLETE SYSTEM BOOKMARKLET
javascript:(function(){
    ...
    ui.innerHTML='<div style="position:fixed;top:10px;right:10px;width:340px;background:linear-gradient(145deg,#0f172a 0%,#1e293b 100%);border:3px solid #06d6a0;border-radius:16px;color:white;font-family:-apple-system,BlinkMacSystemFont,sans-serif;z-index:10000;box-shadow:0 25px 50px rgba(0,0,0,0.5)"><div style="background:linear-gradient(135deg,#06d6a0,#118ab2);padding:10px;border-radius:13px 13px 0 0"><div style="display:flex;justify-content:space-between;align-items:center"><div><h2 style="margin:0;font-size:14px;font-weight:900">⚡ JARVIS ULTIMATE</h2><div style="font-size:8px;opacity:0.9;font-weight:600">COMPLETE TRADING SYSTEM</div></div><button onclick="document.getElementById(\'jarvis-ultimate\').remove()" style="background:rgba(255,255,255,0.2);color:white;border:none;border-radius:50%;width:24px;height:24px;cursor:pointer;font-size:12px">×</button></div></div><div id="jarvis-content"></div></div>';
